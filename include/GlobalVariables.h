#ifndef GlobalVar
#define GlobalVar
extern double sDistI;
extern double rDistI;
...
extern double startPosX;
extern double startPosY;
extern double rDist;
extern double sDist;
